...
const HeroText = () => {
  return (
    <div className='w-full h-[90vh] lg:p-10 p-5 flex'>
      ...
      <span className='heroText z-1 font-[thunder-font] text-black tracking-wider lg:text-[18vh] text-[7vh] absolute lg:top-85 top-50.5 uppercase'>AI Nutrition</span>
      <div className='lg:h-24 lg:w-35 h-10 w-14 lg:top-94 top-53 absolute lg:left-155 left-56'>
