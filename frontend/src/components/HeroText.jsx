...
const HeroText = () => {
  return (
    <div className='w-full h-[85vh] p-10 flex'>
      ...
      <span className='heroText z-1 font-[thunder-font] text-black tracking-wider text-8xl absolute top-86.5 uppercase'>AI Nutrition</span>
      <div className='h-17.5 w-30 top-87 absolute left-115'>
