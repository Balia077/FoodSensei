...
const HeroText = () => {
  return (
    <div className="relative w-full min-h-[91vh] bg-[#EFF5F3] flex items-center justify-center overflow-hidden px-4 sm:px-6 lg:px-10">
      ...
      <div className="absolute w-[400px] h-[400px] sm:w-[700px] sm:h-[700px] lg:w-[900px] lg:h-[900px] rounded-full 
        bg-[radial-gradient(circle,_rgba(34,197,94,0.18)_0%,_transparent_70%)] blur-[60px] sm:blur-[70px]" />
      
      <div className="absolute w-[500px] h-[500px] sm:w-[900px] sm:h-[900px] lg:w-[1100px] lg:h-[1100px] rounded-full 
      ...
      <div className="relative z-10 text-center max-w-2xl lg:max-w-3xl">
        ...
        <p className="mt-4 sm:mt-6 text-gray-500 text-base sm:text-lg">
          Discover healthy recipes, personalized meal plans, and nutrition guidance tailored just for you.
        </p>

        <button className="mt-6 sm:mt-8 px-6 py-3 sm:px-7 sm:py-3.5 text-sm sm:text-base bg-gradient-to-r from-emerald-500 to-green-400 text-white rounded-full shadow-lg hover:scale-105 transition-all duration-300">
          Try it Now →
        </button>
      </div>
    </div>
